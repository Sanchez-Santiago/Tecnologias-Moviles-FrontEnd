...
fun EstadisticasScreen(navController: NavController) {
    Column(
        ...
        Text(
            text = stringResource(R.string.estadisticas_title),
        ...
        Card(
            ...
            Column(modifier = Modifier.padding(16.dp)) {
                Text(stringResource(R.string.total_spending_may_2026), fontWeight = FontWeight.Bold)
                Spacer(modifier = Modifier.height(8.dp))
                Text("$67.500", fontSize = 28.sp, fontWeight = FontWeight.Bold, color = Emerald700)
                Spacer(modifier = Modifier.height(8.dp))
                Text(stringResource(R.string.previous_month_comparison), color = Color.Gray)
            }
        }
        ...
        Card(
            ...
            Column(modifier = Modifier.padding(16.dp)) {
                Text(stringResource(R.string.spending_by_supermarket_title), fontWeight = FontWeight.Bold)
                Spacer(modifier = Modifier.height(16.dp))
        ...
        Card(
            ...
            Column(modifier = Modifier.padding(16.dp)) {
                Text(stringResource(R.string.monthly_evolution_title), fontWeight = FontWeight.Bold)
                Spacer(modifier = Modifier.height(16.dp))
        ...
        Card(
            ...
            Column(modifier = Modifier.padding(16.dp)) {
                Text(stringResource(R.string.most_purchased_products_title), fontWeight = FontWeight.Bold)
                Spacer(modifier = Modifier.height(16.dp))
                ...
                repeat(3) { index ->
                    Row(
                        ...
                        Text(stringResource(R.string.product_item, index + 1))
